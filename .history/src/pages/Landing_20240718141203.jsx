  ...
  return (
    <div className='w-full overflow-hidden'>
            ...
            <div className='w-full h-[150vh] flex'>
                  <div className='w-[60%] leading-[50px] uppercase f1 text-[37px] pl-3 opacity-90 tracking-tight  h-full '>
                    <h1>curtains</h1>
                    <h1 className='leading-none mt-2'>blackout curtains</h1>
                    <h1>sheers</h1>
                    <h1 className='leading-none mt-2'>anti-vandal sheers</h1>
                    <h1 className='leading-none mt-2'>no-noice curtain rods</h1>
                    <h1 className='leading-none mt-2'>decorative pilloww</h1>
                    <h1>table runners</h1>
                    <h1>table cloth</h1>
                    <h1>napkins</h1>
                  </div>

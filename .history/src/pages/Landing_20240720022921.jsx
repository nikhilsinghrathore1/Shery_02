  ...
  return (
    <div className='w-full overflow-hidden'>
         ...
         <XlThird text={"IDEAL TEXTILES FOR A COZY HOTEL AMBIANCE"} img={"https://cdn.prod.website-files.com/6613fb0aff6a7761bf9a817d/662a45b9e8c97f8a31a8f96a_slider-01-05-p-500.webp"}/>
                ...
                <div className='w-full xl:w-[60%] pt-8 sm:pt-5 md:pt-0 flex h-[100vh] sm:h-[83vh] md:h-[77vh] xl:h-[180vh]'>
               <div className='w-[80%] xl:w-full   uppercase leading-none f1 text-[34px] sm:text-[35.5px] md:text-[36.5px] xl:text-[5rem]  pl-3 opacity-90 tracking  h-full '>
                              ...
                              {Dtext[0].map((e,i)=>( <h1 key={i} className='mt-[14px] md:mt-[15px] xl:mt-[10px]'>{e}</h1>))}

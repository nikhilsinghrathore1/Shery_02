                              ...
                              <div className='w-full hidden xl:flex h-[70%] justify-between items-start pt-[73px] px-[10px]  '>
                                {/* this is the about us section for the xl screen */}
                                    ...
                                    <div className='h-full w-[30%] '>
                                      <p className='text-[11.5px] h-fit f4 font-semibold leading-[13px] w-[55%] '>The textile production Velours HoReCa was founded in Lviv in 2005. <span className='opacity-50'>Our activity is focused on professionally outfitting the interiors of hotels, restaurants, cafes, and bars with textile products.</span></p>
                                      {/* this is the scanner component */}
                                      <div className='w-[56%] h-[50%] flex items-end '>
                                          <div className='w-[55%] pr-4 h-full pt-5 rounded-lg overflow-hidden'>
                                                          <div className='w-full h-[90%] border border-black'></div>
                                          </div>

                                          <div className='h-full flex items-end pb-3  w-[45%]'>
                                            <MoreInsta/>
                                          </div>
                                      </div>
                                    </div>

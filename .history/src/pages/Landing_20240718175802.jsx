  ...
  return (
    <div className='w-full overflow-hidden'>
          ...
          <CurtainText text={Dtext[0]} height={"100vh"}/>
            ...
            <div className='w-full mt-10 px-3 h-[100vh]  relative overflow-hidden '>
            <div className='w-[40%] h-[33%] rounded-lg overflow-hidden absolute z-10  top-0 right-2 bg-black'>
            ...
            <h1 className='text-[13px] f1 font-light opacity-90 '>They have chosen us</h1>

            <div className='w-full h-[80vh] mt-10 text-[30px] f1 tracking-tighter uppercase leading-[37px]'>
              <h1>apartel</h1>

...
const Landing = () => {
  return (
    <div className='w-full overflow-hidden'>
          ...
          <div className=' w-full h-[105vh] px-10 relative flex'>
            <div className='w-[35%] h-full text-[2rem] tracking-tighter leading-[2.5rem] f1'>
                      <p className='w-[57%]'>IDEAL TEXTILES FOR A COZY HOTEL AMBIANCE</p>
            </div>

...
{/* this is the increasing text animaiton  section */}
           ...
           <div className='w-full h-[150vh] hidden xl:flex '>
                <div className='w-[25%]  h-full pl-10'>
                  <p className='text-[11px] f4 font-semibold w-[50%] leading-[13px]'>Become our next client right now!</p>
                </div>
                <div className='w-[25%]  h-full'></div>
                <div className='w-[50%]  flex items-start justify-start h-full'></div>
           </div>

  ...
  return (
    <div className='w-full overflow-hidden'>
          ...
          <div className=' w-full h-[100vh] px-7 relative flex'>
            <div className='w-[24%] h-full text-[2rem] tracking-tighter leading-[2.1rem] f1'>
                      <p className='w-[82%] opacity-90'>IDEAL TEXTILES FOR A COZY HOTEL AMBIANCE</p>
            </div>

            <div className='w-[65%] h-[100%] flex justify-start'>
                      {/*this is the first prev section   */}
                    <div className='w-[18%] pb-[250px] h-full flex items-end'>

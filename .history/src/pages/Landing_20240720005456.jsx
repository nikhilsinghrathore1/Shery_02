                            ...
                            <GoArrowLeft className='absolute top-[18%] opacity-70 left-[4%] text-lg' />
                                ...
                                <div className='w-[40%] h-full mr-14'>
                                        <div className='w-full h-[73%] rounded-lg overflow-hidden'>
                                          <img className='w-full h-full object-cover' src="https://cdn.prod.website-files.com/6613fb0aff6a7761bf9a817d/662a45b9e8c97f8a31a8f96a_slider-01-05-p-500.webp" alt="not showing" />
                                        </div>
                                </div>

...
{/* this is the increasing text animaiton  section */}
            ...
            <div className='w-full pt-8 sm:pt-0 flex h-[60vh] xl:h-[80vh] sm:h-[48vh] md:h-[45vh]'>
               <div className='w-[80%]  uppercase leading-none f1 text-[34px] sm:text-[35.5px] md:text-[36.5px] xl:text-[5rem] pl-3 opacity-90 tracking  h-full '>

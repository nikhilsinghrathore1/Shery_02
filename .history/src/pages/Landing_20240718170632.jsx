  ...
  return (
    <div className='w-full overflow-hidden'>
               ...
               <div className='  text-[30px] tracking-tight w-full leading-[35px] f1  '>
                                             ...
                                             <p className='text-[12px] leading-[16px] f5 font- tracking-wide mt-10'>Create an atmosphere of comfort and coziness <span className='opacity-60'> in your hotel with our diverse range of high-quality textiles.</span>Our assortment includes curtains, sheers, decorative pillows, bed runners, and much more to meet all your room décor needs.</p>
                              </div>

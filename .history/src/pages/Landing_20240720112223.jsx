            ...
            <div className='w-full h-[200vh] hidden xl:block px-5'>
                                ...
                                <div className='w-full h-[120vh] mt-10 flex'>
                                  ...
                                  <div className='w-[45%] h-full'>
                                    ...
                                    <div className='w-full leading-[2.2rem] h-[20%] flex uppercase text-[2rem] f1 tracking-tight items-start'>
                                      <p className='w-[60%]'>automated textile management</p>
                                    </div>
                                      {/* the below image */}
                                          <div className='w-full h-[80%] flex justify-end'>
                                            <div className='w-[44%] flex items-center justify-center h-[60%] rounded-lg bg-black'>
                                              <img className='w-[80%] h-[77%] object-contain' src="https://cdn.prod.website-files.com/6613fb0aff6a7761bf9a817d/662b5a9bf1e1110165fff749_pult.webp" alt="not showing" />
                                            </div>
                                          </div>
                                  </div>
                                </div>

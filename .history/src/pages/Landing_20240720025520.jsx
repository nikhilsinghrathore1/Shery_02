    ...
    <div className='w-full overflow-hidden'>
         ...
         <XlThird text={"IDEAL TEXTILES FOR A COZY HOTEL AMBIANCE"} img={"https://cdn.prod.website-files.com/6613fb0aff6a7761bf9a817d/662a45b9e8c97f8a31a8f96a_slider-01-05-p-500.webp"}/>
              ...
              <div className='hidden xl:block w-[38%] h-full '>
                  <p className='text-[11.4px] f1 w-[48.5%] leading-[13px] tracking-tight'>Create an atmosphere of comfort and coziness <span className='opacity-50'>in your hotel with our diverse range of high-quality textiles.</span> Our assortment includes curtains, sheers, decorative pillows, bed runners, and much more to meet all your room décor needs.</p>
              </div>
         </div>

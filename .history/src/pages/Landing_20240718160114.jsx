            ...
            <div className='w-full h-[200vh] px-4 '>
              ...
              {/* this is the paragraph area */}
                      <div>
                          ...
                          <p className='leading-[16px] mt-8 text-[12px] f1'><span className='opacity-60'>Programming for efficiency: automated control allows</span> scheduling the opening and closing of textile products according to sleep schedules. <span></span></p>
                      </div>
            </div>

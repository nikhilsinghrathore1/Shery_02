  ...
  return (
    <div className='w-full overflow-hidden'>
               ...
               <div className='  text-[30px] tracking-tight w-full leading-[35px] f1  '>
                                             ...
                                             <p className='text-[12px] leading-[16px] f5 font-light tracking-wide mt-10 opacity-85'>Create an atmosphere of comfort and coziness <span className='opacity-50'> in your hotel with our diverse range of high-quality textiles.</span>Our assortment includes curtains, sheers, decorative pillows, bed runners, and much more to meet all your room décor needs.</p>
                              </div>

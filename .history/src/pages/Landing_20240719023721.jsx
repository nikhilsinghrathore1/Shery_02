  ...
  return (
    <div className='w-full overflow-hidden'>
          ...
          <ThirdSection/>
                ...
                <div className='w-full pt-8 sm:pt-5 md:pt-0 flex h-[100vh] sm:h-[83vh] md:h-[77vh]'>
               <div className='w-[80%]  uppercase leading-none f1 text-[34px] sm:text-[35.5px] md:text-[36.5px] md:leading-[37px] pl-3 opacity-90 tracking  h-full '>

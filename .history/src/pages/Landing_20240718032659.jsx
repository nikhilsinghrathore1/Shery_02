  ...
  return (
    <div className='w-full overflow-hidden'>
               ...
               <div className=' uppercase text-[32px] w-full leading-[35px] f5 font-light '>
                                             ...
                                             <p className='text-[13px] leading-[16px] font-light'>Create an atmosphere of comfort and coziness <span> in your hotel with our diverse range of high-quality textiles.</span>Our assortment includes curtains, sheers, decorative pillows, bed runners, and much more to meet all your room décor needs.</p>
                              </div>
               </div>

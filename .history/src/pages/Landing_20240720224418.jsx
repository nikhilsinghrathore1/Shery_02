               ...
               <div className='flex items-end pb-8 -ml-5 w-[45%]'>
                 <MoreInsta/>
                                  ...
                                  <div className='w-[24%] h-fit'>
                                    <p> <span className='opacity-50 text-[11.5px] w-[86%] tracking-tight f1 leading-[15px] '>Programming for efficiency: automated control allows</span> scheduling the opening and closing of textile products according to sleep schedules. <span className='opacity-50'>This ensures optimal energy usage and saves time and effort for staff, allowing them to focus on providing high-quality service to their guests.</span></p>
                                  </div>

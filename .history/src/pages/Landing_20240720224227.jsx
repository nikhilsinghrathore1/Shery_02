               ...
               <div className='flex items-end pb-8 -ml-5 w-[45%]'>
                 <MoreInsta/>
                                  ...
                                  <div className='w-[24%] h-fit'>
                                    <p>Programming for efficiency: automated control allows scheduling the opening and closing of textile products according to sleep schedules. This ensures optimal energy usage and saves time and effort for staff, allowing them to focus on providing high-quality service to their guests.</p>
                                  </div>

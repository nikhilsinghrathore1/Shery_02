    ...
    <div className='w-full overflow-hidden'>
         ...
         <XlThird text={"IDEAL TEXTILES FOR A COZY HOTEL AMBIANCE"} img={"https://cdn.prod.website-files.com/6613fb0aff6a7761bf9a817d/662a45b9e8c97f8a31a8f96a_slider-01-05-p-500.webp"}/>
            ...
            <div className='w-full h-[200vh] hidden xl:block px-5'>
                                ...
                                {/* below image section */}
                                <div className='w-full h-[120vh] mt-10 flex'>
                                      ...
                                      {/* the below image */}
                                          <div className='w-full h-[80%] flex justify-end'>
                                            <div className='w-[44%] flex items-center justify-center h-[58%] rounded-lg bg-black'>
                                              <img className='w-[81%] h-[81%] object-contain' src="https://cdn.prod.website-files.com/6613fb0aff6a7761bf9a817d/662b5a9bf1e1110165fff749_pult.webp" alt="not showing" />
                                            </div>
                                          </div>
                                  </div>
                                  {/* this is the second section  */}

                                  <div className='w-[24%] h-[78%] pb-20   pl-5'>
                                              <div className='w-full h-full flex flex-col justify-between  '>
                                                {/* this is the text line  */}
                                                <p className='text-[11.5px] w-[86%] tracking-tight f1 leading-[15px]'>Creating comfort and efficiency: <span className='opacity-50'>automated control of blinds, curtains, and sheers opens up new possibilities for hotels and restaurants striving to create a unique atmosphere for their guests.</span>This technology allows easy control of lighting and privacy, ensuring comfortable conditions throughout the day.</p>
               ...
               <div className='flex items-end pb-8 -ml-5 w-[45%]'>
                 <MoreInsta/>
                                  ...
                                  <div className='w-[24%] h-fit'>
                                    <p> <span className='opacity-50'>Programming for efficiency: automated control allows</span> scheduling the opening and closing of textile products according to sleep schedules. This ensures optimal energy usage and saves time and effort for staff, allowing them to focus on providing high-quality service to their guests.</p>
                                  </div>

  ...
  return (
    <div className='w-full overflow-hidden'>
          ...
          <CurtainText text={Dtext[0]} height={"100vh"}/>
            ...
            <div className='w-full mt-10 px-3 h-[130vh]  relative overflow-hidden '>
            <div className='w-[40%] h-[25%] rounded-lg overflow-hidden absolute z-10  top-0 right-2 bg-black'>

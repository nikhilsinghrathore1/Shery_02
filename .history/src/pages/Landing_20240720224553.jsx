               ...
               <div className='flex items-end pb-8 -ml-5 w-[45%]'>
                 <MoreInsta/>
                                  ...
                                  <div className='w-[24%] h-fit flex justify-end'>
                                    <p className='text-[11.5px] w-[84%] tracking-tight f1 leading-[13px]'> <span className='opacity-50  '>Programming for efficiency: automated control allows</span> scheduling the opening and closing of textile products according to sleep schedules. <span className='opacity-50'>This ensures optimal energy usage and saves time and effort for staff, allowing them to focus on providing high-quality service to their guests.</span></p>
                                  </div>

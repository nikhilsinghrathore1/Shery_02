...
// document that tell how a software is supposed to perform need of software engneering modularity-dividing it into chunks for testing and developing independently
const Landing = () => {
  return (
    <div className='w-full overflow-hidden'>
            ...
            <div className='w-full h-[150vh] flex'>
                  <div className='w-[80%]  uppercase leading-none f1 text-[37px] pl-3 opacity-90 tracking-tight  h-full '>
                    ...
                    <h1 className=' mt-4'>blackout curtains</h1>
                    <h1 className='mt-4'>sheers</h1>
                    <h1 className='leading-none mt-4'>anti-vandal sheers</h1>
                    <h1 className='leading-none mt-4'>no-noice curtain rods</h1>
                    <h1 className='leading-none mt-4'>decorative pilloww</h1>
                    <h1 className='mt-4'>table runners</h1>
                    <h1 className='mt-4'>table cloth</h1>
                    <h1 className='mt-4'>napkins</h1>
                  </div>
            </div>

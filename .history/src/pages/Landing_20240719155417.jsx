               ...
               <div className='w-full  h-[120vh] sm:h-[99vh] xl:h-[105vh] px-4   pt-32 sm:pt-24 xl:pt-[230px] leading-[42px]'>
                              ...
                              <div className='w-full hidden xl:flex h-[70%] justify-between items-start pt-[73px] px-[10px]  '>
                                {/* this is the about us section for the xl screen */}
                                    <div className='text-[11.5px] f4 font-semibold w-[24%] bg-black tracking-tight'><p>More about us</p></div>

                                    {/* this is the first qr scanner section  */}
                                    <div className='h-full w-[30%]'>
                                      <p className='text-[11.5px] f4 font-semibold leading-[13px] w-[60%] '>The textile production Velours HoReCa was founded in Lviv in 2005. <span className='opacity-50'>Our activity is focused on professionally outfitting the interiors of hotels, restaurants, cafes, and bars with textile products.</span></p>
                                    </div>
                              </div>

...
let Dtext=[["curtains","blackout curtains", "sheer","anti-vandal sheers" ,"no-noice curtain rods" , "decorative pillows","table runner" , "table cloth","napkins"],["curtains","sheers","tablecloths" , "napkins" ,"wooden blinds"]]
...
const Landing = () => {
  return (
    <div className='w-full overflow-hidden'>
          ...
          <CurtainText text={Dtext[0]} height={"105vh"}/>

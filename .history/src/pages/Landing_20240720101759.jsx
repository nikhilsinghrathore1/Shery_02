                                    ...
                                    <div className='w-full leading-[2.2rem] h-[20%] flex uppercase text-[2rem] f1 tracking-tight items-start'>
                                      ...
                                      {/* the below image */}
                                          <div className='w-full h-[80%] flex justify-end'>
                                            <div className='w-[44%] h-[60%] rounded-lg bg-black'>
                                              <img className='w-full h-full object-contain' src="https://cdn.prod.website-files.com/6613fb0aff6a7761bf9a817d/662b5a9bf1e1110165fff749_pult.webp" alt="not showing" />
                                            </div>
                                          </div>
                                  </div>
                                </div>

...
{/* this is the increasing text animaiton  section */}
            ...
            <div className='w-full xl:w-[100%]  pt-8  sm:pt-5 md:pt-0 flex h-[100vh] sm:h-[83vh] md:h-[77vh] xl:h-[95vh] xl:pl-4'>
               <div className='w-[80%] xl:w-[73%]    uppercase leading-none f1 text-[34px] sm:text-[35.5px] md:text-[36.5px] xl:text-[4.5rem]  pl-3 opacity-90 tracking  h-full '>

                              {Dtext[1].map((e,i)=>(<div className='rot w-full'> <h1 key={i} className='mt-[14px] rote md:mt-[15px] xl:mt-[9px]'>{e}</h1></div>))}
           ...
           <div className='w-full h-[150vh] hidden xl:flex '>
                <div className='w-[25%]  h-full pl-10'>
                ...
                <div className='w-[25%] h-full flex justify-center'>
                  <div className='w-[70%] h-[30.5%] bg-black rounded-lg'></div>
                </div>
                <div className='w-[50%]  flex flex-col items-start justify-start h-full '>
                  {/*  */}
                  <div className='w-full h-[10vh] '>
                    <p className='text-[11px] f4 font-semibold opacity-80'>They have chosen us</p>
                  </div>

                  <div className='w-full h-[80vh]  justify-start text-[3rem] f1 tracking-tighter uppercase leading-[3.2rem]'>
                 <h1>apartel</h1>
                 <h1 className='opacity-50'>bank hotel</h1>
                 <h1 className='opacity-50'>grand hotel</h1>
                 <h1 className='opacity-50'>glibivka family</h1>
                 <h1 className='opacity-50'>rafael hotel</h1>
                 <h1 className='opacity-50'>panaroma hotel</h1>
                 <h1 className='opacity-50'>lh hotel & spa</h1>
                 <h1 className='opacity-50'>status hotel</h1>
                 <h1 className='opacity-50'>bukovel</h1>
                 <h1 className='opacity-50'>swiss hotel</h1>
                 <h1 className='opacity-50'>eurohotel hotel</h1>
                 <h1 className='opacity-50'>svityaz resort</h1>
                 <h1 className='opacity-50'>kyivska rus</h1>
                 <h1 className='opacity-50'>play karpaty</h1>
               </div>

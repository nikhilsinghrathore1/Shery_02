               ...
               <div className=' uppercase text-[32px] w-full leading-[35px] f5 font-light '>
                                             ...
                                             <div className='w-full flex h-[60vh]'>
                                                            ...
                                                            <div className='w-[70%] h-full rounded-lg overflow-hidden'>
                                                                           <img className='w-full h-[70%] ' src="https://cdn.prod.website-files.com/6613fb0aff6a7761bf9a817d/662a45b943d2e1892a8fff8e_slider-01-04-p-800.webp" alt="not showing" />
                                                            </div>
                                             </div>
                              </div>
               </div>

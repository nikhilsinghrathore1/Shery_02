...
{/* this is the increasing text animaiton  section */}
           ...
           <div className='w-full h-[150vh] hidden xl:flex '>
                <div className='w-[25%] bg-black h-full'>
                  <p className='text-[12px] f4 leading-[14px]'>Become our next client right now!</p>
                </div>
                <div className='w-[25%] bg-red-400 h-full'></div>
                <div className='w-[50%] bg-blue-500 flex items-start justify-start h-full'></div>
           </div>

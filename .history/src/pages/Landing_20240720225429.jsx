                                      ...
                                      {/* the below image */}
                                          <div className='w-full h-[80%] flex justify-end'>
                                            <div className='w-[44%] flex items-center justify-center h-[85%] rounded-lg bg-black'>
                                              <img className='w-[81%] h-[70%] object-contain' src="https://cdn.prod.website-files.com/6613fb0aff6a7761bf9a817d/662b5a9bf1e1110165fff749_pult.webp" alt="not showing" />
                                            </div>
                                          </div>
                                  </div>

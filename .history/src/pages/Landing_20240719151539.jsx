...
const Landing = () => {
  return (
    <div className='w-full overflow-hidden'>
               ...
               <div className='w-full  h-[120vh] sm:h-[99vh] xl:h-[105vh] px-4 pt-32 sm:pt-24 leading-[42px]'>
                              {/* this is the variable weight text */}
                              <div className='w-full xl:h-[40%] h-fit f4 text-[32px] xl:text-[48px] xl:font-light xl:leading-[50px] font-semibold text-black uppercase '>

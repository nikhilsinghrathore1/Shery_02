...
const Landing = () => {
  return (
    <div className='w-full overflow-hidden'>
               ...
               <div className='w-full  h-[120vh] sm:h-[99vh] xl:h-[105vh] px-4   pt-32 sm:pt-24 xl:pt-40 leading-[42px]'>
                              {/* this is the variable weight text */}
                              <div className='w-full xl:h-[40%] h-fit f4 text-[32px] xl:text-[54px] xl:font-light xl:leading-[60px] font-semibold text-black uppercase '>
                                             <p className='xl:pl-16'><span className='pl-44 xl:pl-96'>full</span> responsibility from project to implementation.</p>
                              </div>

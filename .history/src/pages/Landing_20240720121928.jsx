               ...
               <div className='flex items-end pb-8 -ml-5 w-[45%]'>
                 <MoreInsta/>
                                              ...
                                              {/* this is the last line section */}
                                                ...
                                                <div className='w-[85%] border-dashed border-b-[1px] border-black/30 py-1 text-[11px] f1 font-light'>
                                                                <p>lighting through blind controls</p>
                                                              </div>
                                                <div className='w-[85%] border-dashed border-b-[1px] mt-1 border-black/30 py-1 text-[11px] f1 font-light'>

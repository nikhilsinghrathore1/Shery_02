  ...
  return (
    <div className='w-full overflow-hidden'>
               ...
               <div className='w-full  h-[120vh] sm:h-[99vh] xl:h-[105vh] px-4   pt-32 sm:pt-24 xl:pt-[230px] leading-[42px]'>
                              ...
                              <div className='w-full hidden xl:flex h-[70%]  justify-between items-start pt-[73px] px-2 '>
                                    <div className='text-[11.5px] f4 font-semibold tracking-tighter'><p>More about us</p></div>
                              </div>

              ...
              {/* this is the paragraph area */}
                      ...
                      <div className='w-full h-[63vh] relative'>
                          <div className='w-[36%] absolute top-10 right-8 h-[48%] bg-black rounded-lg'>
                            <img className='w-full h-full object-cover' src="https://cdn.prod.website-files.com/6613fb0aff6a7761bf9a817d/662b5a9bf1e1110165fff749_pult.webp" alt="not showing" />
                          </div>
                      </div>
            </div>

               ...
               <div className=' uppercase text-[32px] w-full leading-[35px] f5 font-light '>
                                             ...
                                             <div className='w-full flex h-[50vh] mt-4'>
                                                            <div className='w-[30%] flex items-end  gap-2 h-full'>
                                                                                          <div className='w-9 h-9 border-black flex items-center text-xs justify-center border-[1px]'><GoArrowLeft/></div>
                                                                                          <div className='w-9 h-9 border-black flex items-center text-xs justify-center border-[1px]'><GoArrowRight/></div>
                                                            </div>         

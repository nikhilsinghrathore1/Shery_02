...
const Landing = () => {
  return (
    <div className='w-full overflow-hidden'>
               ...
               <div className='w-full  h-[120vh] px-4 pt-32 ]'>
            ...
            <div className='w-full h-[150vh] flex'>
                  <div className='w-[80%]  uppercase f1 text-[37px] pl-3 opacity-90 tracking-tight  h-full '>
                    ...
                    <h1>sheers</h1>
                    <h1 className=' mt-3'>anti-vandal sheers</h1>
                    <h1 className=' mt-3'>no-noice curtain rods</h1>
                    <h1 className=' mt-3'>decorative pilloww</h1>
                    <h1>table runners</h1>
                    <h1>table cloth</h1>
                    <h1>napkins</h1>
                  </div>

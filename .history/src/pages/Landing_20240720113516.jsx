                                ...
                                <div className='w-full h-[120vh] mt-10 flex'>
                                  ...
                                  <div className='w-[24%] h-full flex flex-col pl-5'>
                                              <div className='w-full h-full '>
                                                <p className='text-[11.5px] w-[87%] f1 leading-[15px]'>Creating comfort and efficiency: <span className='opacity-50'>automated control of blinds, curtains, and sheers opens up new possibilities for hotels and restaurants striving to create a unique atmosphere for their guests.</span>This technology allows easy control of lighting and privacy, ensuring comfortable conditions throughout the day.</p>

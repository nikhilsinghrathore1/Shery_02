...
const Landing = () => {
  return (
    <div className='w-full overflow-hidden'>
               ...
               <div className='w-full  h-[120vh] sm:h-[99vh] xl:h-[105vh] px-4 xl:px-10  pt-32 sm:pt-24 xl:pt-20 leading-[42px]'>
                              ...
                              <div className='w-full xl:h-[40%] h-fit f4 text-[32px] xl:text-[53px] xl:font-light xl:leading-[60px] font-semibold text-black uppercase '>
                                             <p><span className='pl-44 xl:pl-96'>full</span> responsibility from project to implementation.</p>
                              </div>

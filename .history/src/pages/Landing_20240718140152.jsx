    ...
    <div className='w-full overflow-hidden'>
            ...
            <div className='w-full h-[150vh] flex'>
                  <div className='w-[60%] leading-[50px] uppercase f1 text-[38px] tracking-tight  h-full '>
                    <h1>curtains</h1>
                    <h1 className='leading-none'>blackout curtains</h1>
                    <h1>sheers</h1>
                    <h1 className='leading-none'>anti-vandal sheers</h1>
                    <h1 className='leading-none'>no-noice curtain rods</h1>
                    <h1 className='leading-none'>decorative pilloww</h1>
                    <h1>table runner</h1>
                  </div>
            </div>

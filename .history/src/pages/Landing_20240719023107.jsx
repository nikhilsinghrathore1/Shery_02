...
const Landing = () => {
  return (
    <div className='w-full overflow-hidden'>
               ...
               <div className='w-full  h-[120vh] sm:h-[99vh] px-4 pt-32 sm:pt-24 leading-[42px]'>
                              ...
                              <div className='f4 text-[13px] sm:text-[14px] md:text-[14.5px] font-semibold mt-10 leading-none'>
                                             <p>More about us</p>
                                             <p className='mt-3 leading-[16px] sm:leading-[18px] sm:text-[13px] font-semibold'>The textile production Velours HoReCa was founded in Lviv in 2005. <span className='opacity-60'>Our activity is focused on professionally outfitting the interiors of hotels, restaurants, cafes, and bars with textile products.</span></p>
                              </div>
                              ...
                              <div className='w-full flex h-[50vh]  mt-12  '>
                                             ...
                                             <div className='w-1/2 h-full flex flex-col justify-between pl-3 pb-16 sm:pb-28 f5 font-light'>
          ...
          <ThirdSection/>
                ...
                <div className='w-full pt-8 sm:pt-5 flex h-[100vh] sm:h-[83vh]'>
               <div className='w-[80%]  uppercase leading-none f1 text-[34px] sm:text-[35.5px] pl-3 opacity-90 tracking  h-full '>

                              {Dtext[0].map((e,i)=>( <h1 key={i} className='mt-[14px]'>{e}</h1>))}
            ...
            <div className='w-full h-[200vh] sm:h-[160vh] px-4 '>
              ...
              {/* this is the main text area */}
                      <div className='w-[80%] f1 uppercase text-[28px] sm:text-[30px] leading-[31px] sm:leading-[33px] mt-5'>
                          <h1>automated textile management</h1>
                      </div>

              {/* this is the paragraph area */}
                      <div>
                          <p className='leading-[16px]  mt-8 text-[12px] sm:text-[13px] sm:leading-[17px] f5'>Creating comfort and efficiency: <span className='opacity-60'>automated control of blinds, curtains, and sheers opens up new possibilities for hotels and restaurants striving to create a unique atmosphere for their guests. </span> This technology allows easy control of lighting and privacy, ensuring comfortable conditions throughout the day.</p>
                          <p className='leading-[16px]  mt-6 text-[12px] sm:text-[13px] sm:leading-[17px] f5'><span className='opacity-60'>Programming for efficiency: automated control allows</span> scheduling the opening and closing of textile products according to sleep schedules. <span className='opacity-60'>This ensures optimal energy usage and saves time and effort for staff, allowing them to focus on providing high-quality service to their guests.</span></p>
                      </div>
                      ...
                      <div className='w-full h-[63vh] relative'>
                        {/* this is the black bg images of remote kinda thingy could be viberator if you have imagination or need  */}
                          ...
                          <div className='absolute -bottom-20 sm:-bottom-4 right-[60px] '>
                          <MoreInsta/>
                          </div>
                      </div>
                          <div className='mt-24  h-[50vh] w-full pt-8 sm:pt-0 '>
            ...
            <div className='w-full pt-8 sm:pt-0 flex h-[60vh] sm:h-[48vh]'>
               <div className='w-[80%]  uppercase leading-none f1 text-[34px] sm:text-[35.5px] pl-3 opacity-90 tracking  h-full '>

                              {Dtext[1].map((e,i)=>( <h1 key={i} className='mt-[14px]'>{e}</h1>))}

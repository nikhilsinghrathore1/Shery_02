                              ...
                              <div className='w-full hidden xl:flex h-[70%] justify-between items-start pt-[73px] px-[10px]  '>
                                {/* this is the about us section for the xl screen */}
                                    ...
                                    <div className='h-full w-[30%]'>
                                      <p className='text-[11px] f4 font-semibold leading-[13px] w-[52%] tracking-tight '>The textile production Velours HoReCa was founded in Lviv in 2005. <span className='opacity-50'>Our activity is focused on professionally outfitting the interiors of hotels, restaurants, cafes, and bars with textile products.</span></p>
                                    </div>
                              </div>

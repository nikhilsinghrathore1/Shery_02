  ...
  return (
    <div className='w-full overflow-hidden'>
               ...
               <div className='w-full  h-[200vh] px-4 pt-32'>
                              <div className='w-full f4 text-[26px] font-semibold text-black uppercase h-fit'>
                                             <p><span className='pl-24'>full</span> responsibility from project to implementation.</p>
                              </div>
               </div>

...
// document that tell how a software is supposed to perform need of software engneering
const Landing = () => {
  return (
    <div className='w-full overflow-hidden'>
            ...
            <div className='w-full h-[150vh] flex'>
                  <div className='w-[60%] leading-[50px] uppercase f1 text-[40px] pl-3 tracking-tight  h-full '>
                    <h1>curtains</h1>

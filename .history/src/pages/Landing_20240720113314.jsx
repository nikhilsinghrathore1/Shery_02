         ...
         <XlThird text={"IDEAL TEXTILES FOR A COZY HOTEL AMBIANCE"} img={"https://cdn.prod.website-files.com/6613fb0aff6a7761bf9a817d/662a45b9e8c97f8a31a8f96a_slider-01-05-p-500.webp"}/>
            ...
            <div className='w-full h-[200vh] hidden xl:block px-5'>
                                ...
                                <div className='w-full h-[120vh] mt-10 flex'>
                                  ...
                                  <div className='w-[24%] h-full flex flex-col pl-5'>
                                              <div className='w-full h-full bg-black'>
                                                <p>Creating comfort and efficiency: <span className='opacity-50'>automated control of blinds, curtains, and sheers opens up new possibilities for hotels and restaurants striving to create a unique atmosphere for their guests.</span></p>

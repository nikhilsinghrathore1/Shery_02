    ...
    <div className='w-full overflow-hidden'>
               ...
               <div className='w-full  h-[200vh] px-4 pt-32 leading-[42px]'>
                              ...
                              <div className='w-full flex h-[50vh] mt-12 '>
                                             ...
                                             <div className='w-1/2 h-full flex flex-col justify-between pl-3 f4 font-semibold'>

                                                            <div className='w-full leading-[16px]  pb-1 text-[13.5px]'>
                                                                           <p>With extensive experience in the Horeca sector - 18 years </p>
                                                                           <p className='opacity-70'>[as of 2024]</p>

                                                                           <div className='border-y-[1px] border-black/20 py-2 mt-2'>

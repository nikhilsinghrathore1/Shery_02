  ...
  return (
    <div className='w-full overflow-hidden'>
            ...
            <div className='w-full h-[150vh] flex'>
                  <div className='w-[80%]  uppercase leading-none f1 text-[37px] pl-3 opacity-90 tracking-tight  h-full '>
                    <h1 className=''>curtains</h1>
                    <h1 className=' mt-[15px]'>blackout curtains</h1>
                    <h1 className='mt-[15px]'>sheers</h1>
                    <h1 className='leading-none mt-[15px]'>anti-vandal sheers</h1>
                    <h1 className='leading-none mt-[15px]'>no-noice curtain rods</h1>
                    <h1 className='leading-none mt-[15px]'>decorative pilloww</h1>
                    <h1 className='mt-[15px]'>table runners</h1>
                    <h1 className='mt-[15px]'>table cloth</h1>
                    <h1 className='mt-[15px]'>napkins</h1>
                  </div>
            </div>

  ...
  return (
    <div className='w-full overflow-hidden'>
          ...
          <CurtainText text={Dtext[0]} height={"100vh"}/>
            ...
            <div className='w-full h-[80vh] mt-10 text-[30px] f1 uppercase leading-none'>
              <h1>apartel</h1>
              <h1>bank hotel</h1>
              <h1>grand hotel</h1>
              <h1>glibivka family</h1>
              <h1>rafael hotel</h1>
              <h1>panaroma hotel</h1>
              <h1>lh hotel & spa</h1>
              <h1>status hotel</h1>
              <h1>bukovel</h1>
              <h1>swiss hotel</h1>
              <h1>eurohotel hotel</h1>
              <h1>svityaz resort</h1>
              <h1>kyivska rus</h1>
              <h1>play karpaty</h1>
            </div>
            </div>

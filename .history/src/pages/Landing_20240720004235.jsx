...
const Landing = () => {
  return (
    <div className='w-full overflow-hidden'>
          ...
          <div className=' w-full h-[100vh] px-7 relative flex'>
            <div className='w-[20%] h-full text-[2rem] tracking-tighter leading-[2.1rem] f1'>
                      <p className='w-[89%] opacity-90'>IDEAL TEXTILES FOR A COZY HOTEL AMBIANCE</p>
            </div>

            <div className='w-[65%] h-[100%] flex justify-start'>
                      {/*this is the first prev section   */}
                    <div className='w-[20%] pb-[250px] h-full flex items-end'>
                                <div className='flex text-[13px] items-center uppercase gap-3  f4 font-semibold '>
                                      <p>prev.</p>
                                      <div className='relative ' >

                                      <svg className='flex items-center justify-center' xmlns="http://www.w3.org/2000/svg" width="25%" height="25%" viewBox="0 0 40 40" fill="none">
                            ...
                            <GoArrowLeft className='absolute top-[23%] opacity-70 left-[6%] text-lg' />
                                      </div>
                                </div>
                                ...
                                <div className='w-[40%] h-full'>
                                        <div className='w-[90%] h-[60%] rounded-lg bg-black'></div>
                                </div>
            </div>

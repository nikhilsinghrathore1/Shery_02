  ...
  return (
    <div className='w-[94%] h-[80%] bg-black rounded-lg pt-[3px] px-[2px] '>
               ...
               <div className='w-full h-[13%] '>
                              <img className='w-3 h-3 object-cover' src="https://cdn.prod.website-files.com/6613fb0aff6a7761bf9a817d/663bcbd3012e5e6821be914c_logo-horeca.png" alt="not showing" />
               </div>
    </div>
  )
}

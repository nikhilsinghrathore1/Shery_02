    ...
    <div className='w-full h-[100vh]  '>
                              ...
                              <div className='h-[15%] w-full px-5 pt-2 relative hidden xl:block'>
                                <div className='w-full h-[55%] border-dashed border-black/30 border-b-[1px] flex  '>
                                                        ...
                                                        <div className='w-[10%]  flex justify-end h-full f1 bg-black  tracking-tighter leading-[15px] font-semibold text-[12px] '>
                                                          <p className='flex items-center bg-red-300 w-fit gap-1'>back to top <GoArrowUp/></p>
                                                        </div>
                                </div>
                              </div>
    </div>

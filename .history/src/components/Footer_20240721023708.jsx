  ...
  return (
    <div className='w-full h-[100vh]  '>
                              ...
                              <div className='h-[15%] w-full px-2 relative hidden xl:block'>
                                <div className='w-full h-[50%] border-dashed border-black/30 border-b-[1px] flex  '>
                                                        <div className='h-full f1 tracking-tight leading-[15px] font-semibold text-[11px] pl-5  w-[20%] '>

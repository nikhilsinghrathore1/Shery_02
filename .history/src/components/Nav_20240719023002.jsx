  ...
  return (
    <div className='w-full h-[100vh]  fixed text-white flex flex-col justify-between z-40 top-0'>
        <div className=' flex items-center justify-center pt-7'>
               ...
               <div className='flex  flex-col items-center justify-center sm:leading-[22px] md:leading-[25px] leading-[18px]'>
                              <h1 className='text-[24px] sm:text-[30px] md:text-[33px] f1'>Velorus</h1>
                              <h2 className='text-[10px] sm:text-[14px] md:text-[15px] f1 '>HoReCa</h2>
               </div>
        </div>
        ...
        <div className='w-full h-[10vh]  px-3  '>
          ...
          <div className='w-full h-[65%] bg-black rounded-md flex justify-between px-[2px]'>
            ...
            <div className='w-[57%] h-full text-[13px] sm:text-[14px] text-white leading-[16px] f2 flex items-center justify-center'>

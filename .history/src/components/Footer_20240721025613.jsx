    ...
    <div className='w-full h-[100vh]  '>
                              ...
                              <div className='h-[15%] w-full px-5 pt-2 relative hidden xl:block'>
                                <div className='w-full h-[55%] border-dashed border-black/30 border-b-[1px] flex  '>
                                                        ...
                                                        <div className=' w-[38.5%] h-full bg-black'></div>

                                                        <div className='w-fit h-full mr-20 f1 tracking-tighter leading-[15px] font-semibold text-[12px] '>
                                                          <p>+38 067 718 3556</p>
                                                        </div>

                                                        <div className='w-[10%] bg-red-300 text-right h-full f1 tracking-tighter leading-[15px] font-semibold text-[12px] '>
                                                          <p>+38 067 718 3556</p>
                                                        </div>
                                </div>
                              </div>

  ...
  return (
               ...
               <div className='  text-[30px] tracking-tight w-full leading-[35px] f1  '>
                              ...
                              <div className='w-full flex h-[60vh]  mt-14'>
                                             ...
                                             <div className='w-[45%] h-full pb-20 sm:pb-[135px] pl-3 sm:pl-[13px] flex items-end '>
                                                            <MoreInsta/>
                                             </div>
                              </div>
               </div>

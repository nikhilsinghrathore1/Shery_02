    ...
    <div className='w-full h-[100vh]  '>
                              ...
                              <div className='h-[15%] w-full px-5 pt-2 relative hidden xl:block'>
                                <div className='w-full h-[55%] border-dashed border-black/30 border-b-[1px] flex  '>
                                                        <div className='h-full f5 tracking-tight leading-[15px] font-extrabold text-[11.3px] pl-2  w-[25%] '>
                                                              <p className='w-[48%]'>Full responsibility from project to implementation.</p>
                                                        </div>
                                                        <div className='h-full flex justify-end f5 tracking-tight leading-[15px] font-extrabold text-[11.3px] pl-2  w-[11%] '>
                                                              <p className='w-[100%]'>Ukraine, Lviv, Zamarsynivska Street 53</p>
                                                        </div>

                                                        <div className=' w-[39%] h-full bg-black'></div>

                                                        <div className='w-[10%] h-full f1 tracking-tighter leading-[15px] font-semibold text-[12px] '>
                                                          <p>+38 067 718 3556</p>
                                                        </div>

                                                        <div className='w-[10%] mr-40 text-right h-full f1 tracking-tighter leading-[15px] font-semibold text-[12px] '>
                                                          <p>+38 067 718 3556</p>
                                                        </div>
                                </div>
                              </div>

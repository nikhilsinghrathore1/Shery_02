...
const Nav = () => {
  return (
    <div className='w-full h-[100vh]  fixed text-white flex flex-col justify-between z-40 top-0'>
        <div className=' flex items-center  justify-center xl:justify-between xl:px-8  pt-7 xl:pt-3'>

                <div className='text-[11px] hidden xl:block leading-[18px] f1'>
                  <p>UA +8005602458</p>
                  <p className='text-[8px] opacity-50'>Friday 9 2024</p>
                </div>
               ...
               <div className='text-[11px] hidden xl:block leading-[18px] f1'>
                  <p>49.734.34.52 .24.01.573.1</p>
                  <p className='text-[8px] opacity-50'>ab ki baar 75 hazar nahi aae toh damm</p>
                </div>

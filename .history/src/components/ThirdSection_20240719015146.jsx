...
const ThirdSection = () => {
  return (
               ...
               <div className='  text-[30px] tracking-tight w-full leading-[35px] f1  '>
                                             <p className='w-[80%] uppercase opacity-90 sm:tracking-tighter'>ideal textile for a cozy hotel ambiance</p>

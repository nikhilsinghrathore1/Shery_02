...
const IncText = () => {
  ...
  return (
    <div className='w-full px-1  pt-28 xl:pt-0 xl:items-start flex h-[80vh] sm:h-[100vh] xl:h-[90vh]'>
               <div className='w-[60%]   flex items-center leading-none  justify-center xl:justify-end text-[21rem] xl:text-[35rem] font-light f1'>{num}</div>

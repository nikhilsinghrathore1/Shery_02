  ...
  return (
    <div className='w-full h-[100vh]  fixed text-white flex flex-col justify-between z-40 top-0'>
        ...
        <div className='w-full h-[10vh] pb-1 px-3  '>
          ...
          <div className='w-full h-[50%] bg-black rounded-md flex justify-between px-[2px]'>
            ...
            <div className='w-[55%] h-full text-[13px] text-white leading-[15px] f2 flex items-center justify-center'>

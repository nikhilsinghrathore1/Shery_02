...
const VideoCont = () => {
  return (
    <div className='w-[98%] h-[80%] sm:h-[73%] sm:w-full bg-black rounded-lg pt-[3px] px-[2px] '>
               ...
               <div className='w-full text-white text-[11px] sm:text-[13px] sm:tracking-tight f1 h-[13%] pt-1 flex items-center pb-[2px] gap-2'>

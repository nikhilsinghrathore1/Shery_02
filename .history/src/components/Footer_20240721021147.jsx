...
const Footer = () => {
  return (
    <div className='w-full h-[100vh]  '>
                              ...
                              <div className='h-[85%] w-full relative text-center pt-20 sm:pt-32 leading-none tracking-wide uppercase pb-40 bg-lime-50'>
                                          <h1 className='text-[5.1rem] xl:text-[17rem] f4 xl:font-semibold xl:tracking-[24px] xl:leading-none'>Horeca</h1>

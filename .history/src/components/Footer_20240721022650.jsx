  ...
  return (
    <div className='w-full h-[100vh]  '>
                              ...
                              <div className='h-[85%] w-full relative text-center pt-20 sm:pt-32 leading-none tracking-wide uppercase '>
                                          <h1 className='text-[5.1rem] xl:text-[15.5rem] z-10 f1 xl:font xl:tracking-[53px] xl:leading-[10px]'>Horeca</h1>
                                          <h2 className='tracking-[14px] text-[12px] mt-1 z-10 font-bold xl:font-semibold xl:pr-[270px] f1 xl:mt-[110px] xl:text-[1.65rem] xl:tracking-[38px] xl:f4'>velours</h2>

...
const VideoCont = () => {
  return (
    <div className='w-[98%] h-[80%] bg-black rounded-lg pt-[3px] px-[2px] '>
               <div className='w-full h-[87%] sm:h-[80%] overflow-hidden rounded-lg'>
               ...
               <div className='w-full text-white text-[11px] f1 h-[13%] pt-1 flex items-center pb-[2px] gap-2'>

    ...
    <div className='w-full h-[100vh]  '>
                              ...
                              <div className='h-[15%] w-full px-5 pt-2 relative hidden xl:block'>
                                <div className='w-full h-[55%] border-dashed border-black/30 border-b-[1px] flex  '>
                                                        <div className='h-full f5 tracking-tight leading-[15px] font-extrabold text-[11.3px] pl-2  w-[20%] '>
                                                              <p className='w-[58%]'>Full responsibility from project to implementation.</p>
                                                        </div>
                                                        <div className='h-full flex justify-end f5 tracking-tight leading-[15px] font-extrabold text-[11.3px] pl-2  w-[18%] '>
                                                              <p className='w-[58%]'>Ukraine, Lviv, Zamarsynivska Street 53</p>
                                                        </div>
                                </div>
                              </div>
    </div>

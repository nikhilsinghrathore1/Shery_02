    ...
    <div className='w-full h-[100vh]  fixed text-white flex flex-col justify-between z-40 top-0'>
        ...
        <div className='w-full xl:w-[33%] xl:mx-auto h-[10vh] xl:h-[11vh]   px-3  '>
          ...
          <div className='w-full h-[65%] bg-black rounded-md flex justify-between px-[2px] xl:p-1'>
            ...
            <div className='w-[57%]   xl:text-[12.5px] h-full text-[13px] sm:text-[14px] md:text-[15px] text-white leading-[16px] f2 flex items-center justify-center'>
              <p>Download our Brochour on services in the HoReCa industry</p>
            </div>


            <div className='w-[15%] xl:w-[22%] h-full bg-white flex items-center justify-center overflow-hidden rounded-md'>
              <img className='w-[80%] xl  h-[80%] object-cover' src="https://cdn.prod.website-files.com/6613fb0aff6a7761bf9a817d/6624bdfbd80898e1c3060de1_download-icon.webp" alt="not showing" />
            </div>
          </div>

...
const CurtainText = ({text}) => {
               console.log(text)
  return (
               <div className='w-full pt-12 flex' style={{height:"105vh"}}>
               {/* <div className='w-[80%]  uppercase leading-none f1 text-[34px] pl-3 opacity-90 tracking  h-full '>
                 ...
                 <h1 className='leading-none mt-[14px]'>{text[3]}</h1>
                 <h1 className='leading-none mt-[14px]'>{text[4]}</h1>
                 <h1 className='leading-none mt-[14px]'>{text[5]}</h1>

    ...
    <div className='w-full h-[100vh]  '>
                              ...
                              <div className='h-[15%] w-full px-5 pt-2 relative hidden xl:block'>
                                <div className='w-full h-[55%] border-dashed border-black/30 border-b-[1px] flex  '>
                                                        <div className='h-full f5 tracking-tighter leading-[15px] font-extrabold text-[11px] pl-2  w-[20%] '>
                                                              <p className='w-[64%]'>Full responsibility from project to implementation.</p>
                                                        </div>
                                </div>
                              </div>
    </div>
